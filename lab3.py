...
def GOST_sign(m: bytearray) -> bool:
    ...
    with open(r'lab3signs\signs\GOST_sign.txt', 'w') as f:
        f.write(str(s))
...
if __name__ == '__main__':
    try:
        shutil.rmtree('lab3signs\signs')
    except OSError:
        pass
    os.mkdir('lab3signs\signs')
    filename = 'input'
    filename_fake = "lab3signs\input_fake"
    ext = 'txt'
    ...
    print()
    s = RSA_sign(m)
    with open(r'lab3signs\signs\rsa_sign.txt', 'w') as f:
        f.write(str(s))
    RSA_signcheck(m, s)
    print()
    s = ElGamal_sign(m)
    with open(r'lab3signs\signs\elgamal_sign.txt', 'w') as f:
        f.write(str(s))
